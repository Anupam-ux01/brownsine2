...
M.__b = function(t) {
    ...
    I && I(t);
    var e = t.__c;
    e && e.__H && (e.__H.__h.length && (1 !== C.push(e) && E === M.requestAnimationFrame || ((E = M.requestAnimationFrame) || W)(q)), e.__H.__.forEach((function(t) {
...
function Q(t) {
    return tt(t).map((t => t instanceof Error ? t : new et(`[${typeof t}] ${function(t){if("string"!=typeof t)try{return JSON.stringify(t)??typeof t}catch{}return`
        $ {
            t
        }
        `}(t).slice(0,10240)}`)))
...
var ct = "e35d7136cee78d344ccffdbd5ca710fa";
class lt extends h {
    counter(t) {
...
const dt = ["Load failed", "Failed to fetch", "when attempting to fetch resource"],
    ut = ["Failed to fetch dynamically imported module", "Importing a module script failed"],
    pt = new Set(["ShopPayPaymentRequest", "ShopPayPaymentRequestButton", "ShopPayPaymentRequestLogin"]),
    ht = ["NotFoundError", "NotSupportedError", "ReferenceError", "SyntaxError", "TypeError"],
    ft = ["pc", "android"],
    gt = t => {
        const {
            errorClass: e,
        ...
        return Boolean("NetworkError" === e || dt.some((t => null == o ? void 0 : o.includes(t))) || (n = o, Boolean((null == n ? void 0 : n.includes("A network failure may have prevented the request from completing")) || (null == n ? void 0 : n.includes("Backpressure applied")))));
        var n
    },
    mt = ({
        event: t,
        ...
        if (((t, e) => {
                const {
                    errorClass: o,
                    message: n
                } = t, r = "SecurityError" === o && (null == n ? void 0 : n.includes("Failed to read the 'cookie' property from 'Document'")) && (null == n ? void 0 : n.includes("sandboxed")), i = "SecurityError" === o && (null == n ? void 0 : n.includes("Blocked a frame with origin")) && (null == n ? void 0 : n.includes("from accessing a cross-origin frame")), a = "string" == typeof e && pt.has(e), s = t.stacktrace.some((t => t.inProject));
                return Boolean(!s || r || i && a)
            })(h, "string" == typeof g ? g : void 0)) return !1;
        if ((t => ht.includes(t.errorClass))(h)) return !1;
        if ((t => "BugsnagInvalidError" === t.errorClass)(h)) return !1;
        if ((t => {
                const {
                    message: e
                } = t;
                return Boolean(ut.some((t => null == e ? void 0 : e.includes(t))))
...
var xt = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/i;

function _t(t) {
    return "string" == typeof t && xt.test(t)
}
...
function St() {
    return Boolean(a.userAgent) && /(android|iphone|ipad|mobile|phone)/i.test(a.userAgent) || function() {
        ...
        const t = a.userAgent;
        return RegExp(Ot).test(t) || RegExp(It).test(t)
...
const Ot = "(iPod|iPod touch|iPhone|iPad);.*CPU.*OS[ +](\\d+)_(\\d+)(?:_(\\d+)|).* AppleNews",
    It = "(iPod|iPod touch|iPhone|iPad);.*CPU.*OS[ +](\\d+)_(\\d+)(?:_(\\d+)|)(?!.*Version).*Mobile(?!.*Safari)",
    jt = e({
        log: () => {
...
class Rt {
    ...
    do(t, e) {
        return Ht(t) ? this.producer.produce(t) : this.producer.produceBatch(t)
    }
}
...
function $t(t) {
    return t.events.map((t => {
        let e = !0,
            o = !0;
        return t && t.options && Object.prototype.hasOwnProperty.call(t.options, "convertEventCase") && (e = Boolean(t.options.convertEventCase)), t && t.options && Object.prototype.hasOwnProperty.call(t.options, "convertMetaDataCase") && (o = Boolean(t.options.convertMetaDataCase)), Dt({
            schema_id: t.schemaId,
            payload: Vt(t.payload, e)
        }, t.metadata && {
            metadata: Vt(t.metadata, o)
        })
    }))
}
class Wt extends Error {
    constructor(t) {
        super(`Error producing to the Monorail Edge. Response received: ${JSON.stringify(t)}`), zt(this, "name", "MonorailUnableToProduceError"), this.response = t, Object.setPrototypeOf(this, Wt.prototype)
    }
}
class Xt extends Error {
    constructor(t) {
        super(`Response not from Monorail Edge. Response received: ${JSON.stringify(t)}`), zt(this, "name", "MonorailInterceptedProduceError"), this.response = t, Object.setPrototypeOf(this, Xt.prototype)
    }
}
class Kt extends Error {
    constructor(t) {
        super(`Error producing to the Monorail Edge. Response received: ${JSON.stringify(t)}`), zt(this, "name", "MonorailBatchProduceError"), Object.setPrototypeOf(this, Kt.prototype), this.response = t
    }
}
class Yt extends Error {
    constructor(t, e) {
        super(`Error completing request. A network failure may have prevented the request from completing. Error: ${t}. Schemas: ${Array.from(new Set(e)).join(", ")}`), zt(this, "name", "MonorailRequestError"), Object.setPrototypeOf(this, Yt.prototype)
    }
}
class Jt extends Error {
    constructor(t, e) {
        super(`Error reading response from Monorail Edge. Status: ${e||"unknown"}. Error: ${(null==t?void 0:t.message)||"Unknown error"}`), zt(this, "name", "MonorailResponseReadError"), this.error = t, this.status = e, Object.setPrototypeOf(this, Jt.prototype)
    }
}
class Gt {
    static withEndpoint(t) {
        return new Gt(`https://${new URL(t).hostname}`)
    }
    constructor(t = Nt, e = {}) {
        var o, n;
    ...
    async produceBatch(t) {
        const e = {
            events: $t(t),
            metadata: Vt(t.metadata)
        };
        let o, n;
        try {
            o = await fetch(this.produceBatchEndpoint(), {
                method: "post",
                headers: Zt(t.metadata),
                body: JSON.stringify(e),
                keepalive: this.keepalive
            })
        } catch (e) {
            throw new Yt(e, t.events.map((t => t.schemaId)))
        }
        if (207 === o.status) {
        ...
        try {
            ...
            throw new Jt(t, o.status)
        }
        if (!o.ok) {
            if (!Boolean(o.headers.get("x-request-id")) && this.detectInterceptedErrorEnabled) throw new Xt({
                status: o.status,
                message: n
            });
            throw new Wt({
    ...
    async produce(t) {
        ...
        try {
            e = await async function({
                ...
                return fetch(null != t ? t : Lt + Ut, {
                    method: "post",
                    headers: Zt(e.metadata),
                    body: JSON.stringify({
                ...
                keepalive: this.keepalive,
                event: Dt(Dt({}, t), {}, {
                    payload: Vt(t.payload, n)
                })
            })
        } catch (e) {
            throw new Yt(e, [t.schemaId])
        }
        if (!e) throw new Wt({
        ...
        try {
            ...
            throw new Jt(t, e.status)
        }
        if (!e.ok) {
            if (!Boolean(e.headers.get("x-request-id")) && this.detectInterceptedErrorEnabled) throw new Xt({
                status: e.status,
                message: o
            });
            throw new Wt({
...
function Zt(t) {
    const e = {
        ...
        "X-Monorail-Edge-Client-Message-Id": (t && t.clientMessageId || Ft()).toString()
    };
...
class Qt {
    ...
    constructor(t) {
        this.sendToConsole = t, t && Qt.printWelcomeMessage(t)
    }
    async produce(t) {
...
class ee {
    constructor(t, e = () => !1) {
        if (zt(this, "eventsAwaitingConsent", []), null == t || !t.provider) throw new oe("ConsentTrackingMiddleware requires an instance of ConsentTrackingProvider");
...
function me(t, e = !1) {
    ...
    if (e && "_tracking_consent" === t && !window.localStorage.getItem("tracking_consent_fetched")) {
        ...
        return console.debug("_tracking_consent missing"),
            ...
            }(), window.localStorage.setItem("tracking_consent_fetched", "true"), me(t, !1)
    }
}

function ve() {
    const t = new URLSearchParams(window.location.search).get("_cs") || me("_tracking_consent");
    if (void 0 !== t) return function(t) {
        ...
        if ("3" == e) return function(t) {
            ...
            function l(t) {
                const e = o.split(".")[0];
                return e.includes(t.toLowerCase()) ? ae : e.includes(t.toUpperCase()) ? ie : re
            }
...
function ke() {
    const t = [];
    return be() && t.push("analytics"), xe() && t.push("marketing"), _e() && t.push("sale_of_data"), ye() && t.push("preferences"), t
}
class Ee extends te {
    async annotateEvent(t) {
        return Promise.resolve(function(t, e) {
            ...
            throw new Se(e || "unknown")
        }(t, this.version))
    }
    getRequiredConsentForEmission() {
        if ("v1" === this.version) return ["analytics", "marketing"];
        throw new Se(this.version || "unknown")
    }
}
class Se extends Error {
    constructor(t) {
        super(`Version ${t} is not supported by the consent-tracking-api provider`), this.name = "MonorailConsentTrackingApiProviderVersionError", Object.setPrototypeOf(this, Se.prototype)
    }
}
...
function Pe(...t) {
    return l(this, void 0, void 0, (function*() {
        ...
        let o;
        Boolean(null === (e = c.trekkie) || void 0 === e ? void 0 : e.ready) ? o = Me() : (c.trekkie = c.trekkie || [], o = new Promise((t => {
...
const Ie = "unspecified",
    ...
    Ae = ["completed", "emailsubmitted", "namesubmitted", "sheetmodalclosed", "sheetmodalopened"],
    Te = class t {
        static createLogProducer(e) {
            return new t(new Qt(e.debugMode), e.middleware || [])
        }
        static createHttpProducerWithEndpoint(e, o = []) {
            return new t(Gt.withEndpoint(e), o)
        }
        static createHttpProducer(e) {
            return new t(e.production ? new Gt(Lt, e.options) : new Gt(Nt, e.options), e.middleware || [])
        }
        static buildMiddlewareChain(t, e = 0) {
            return e === t.length ? this.identityFn : o => t[e].do(o, this.buildMiddlewareChain(t, e + 1))
        }
        constructor(e, o) {
            this.producer = e, this.middleware = o, this.executeChain = t.buildMiddlewareChain(this.middleware.concat(new Rt(e)))
        }
        produce(t) {
            return t.metadata = Dt({
...
class ze {
    constructor({
        ...
        var r;
        Oe.set(this, void 0), this.featureInitializationEventAlreadyEmitted = !1, this.trackedPageImpressions = new Set, d(this, Oe, Object.assign(Object.assign({}, t), {
            flowVersion: null !== (r = t.flowVersion) && void 0 !== r ? r : Ie
    ...
    set analyticsData(t) {
        const e = Object.assign(Object.assign({}, u(this, Oe, "f")), t);
        ne(e, u(this, Oe, "f")) || d(this, Oe, e, "f")
    }
    ...
    trackFeatureInitialization() {
        return l(this, void 0, void 0, (function*() {
            ...
            const f = Ce(),
                ...
                m = yield Pe("customerId", "isPersistentCookie", "path", "uniqToken", "visitToken"), v = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, i && {
                    apiKey: i
                }), a && {
                    checkoutToken: a
                }), u && {
    ...
    trackPageImpression(t) {
        return l(this, arguments, void 0, (function*({
            ...
            const p = Ce(),
                ...
                f = yield Pe("customerId", "isPersistentCookie", "path", "uniqToken", "visitToken"), g = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, l && {
                    apiKey: l
                }), d && {
                    checkoutToken: d
                }), r && {
...
function Be(t) {
    if (!t) return !1;
    try {
        return _t(t) && 4 === function(t) {
            if (!_t(t)) throw TypeError("Invalid UUID");
...
const De = ({
    ...
    const {
        ...
        analyticsData: v.current,
        devMode: f,
        notify: p,
        recordCounter: h
    })), [f, p, h]);
    w.analyticsData = Object.assign(Object.assign({}, v.current), {
        analyticsTraceId: m,
        analyticsContext: t,
        apiKey: e,
        checkoutVersion: o,
        ...
        w.clearTrackedPageImpressions()
    }), [w]);
    const b = Et((() => {
        w.trackFeatureInitialization()
    }), 100);
    N((() => {
        b()
    }), [b]);
    const x = R((() => ({
        analyticsData: w.analyticsData,
        getTrekkieAttributes: Pe,
        produceMonorailEvent: w.produceMonorailEvent,
        trackModalStateChange: w.trackModalStateChange,
        trackPageImpression: w.trackPageImpression,
        trackUserAction: w.trackUserAction,
        trackPostMessageTransmission: w.trackPostMessageTransmission
    })), [w.analyticsData, w.produceMonorailEvent, w.trackModalStateChange, w.trackPageImpression, w.trackUserAction, w.trackPostMessageTransmission]);
...
! function() {
    if ("undefined" != typeof document && !("adoptedStyleSheets" in document)) {
        ...
        if (T.prototype = {
                ...
                connect: function() {
                    var t = j(this);
                    v.get(this).observe(t, h), m.get(this).length > 0 && A(this), I(t, (function(t) {
                        P(t).connect()
                    }))
                },
                disconnect: function() {
...
function $e(t, {
    ...
    function f() {
        const e = (t => Fe((() => Reflect.construct(HTMLElement, [], t))))(f);
        if (e._eventListenerReadyPromise = new Promise((t => {
            ...
            t.replaceSync(He), e._root.adoptedStyleSheets = [t]
        }
        return e
    }
    const g = new Map;
...
export {
    U as A, vt as B, H as F, Tt as M, Ue as R, lt as S, R as T, L as _, Z as a, y as b, yt as c, B as d, He as e, Et as f, St as g, Ve as h, Mt as i, D as j, ne as k, Pt as l, Le as m, ze as n, Pe as o, Ct as p, F as q, $e as r, At as u, V as x, N as y
};
//# sourceMappingURL=chunk.index_BpfL6aWy.esm.js.map